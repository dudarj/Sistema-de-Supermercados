 ...
 */
package com.mycompany.supermercado.view.web.filter;
...
public class autenticacaoFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (c == null && !url.equalsIgnoreCase("/main/MainViewController")) {
             RequestDispatcher rd = request.getRequestDispatcher("/index.jsp?url="+url);
             request.setAttribute("Mensagem", "Obrigatório autenticar-se ao sistema.");
             return;
        }
        else {
        ...
        if (debug) {
            log("autenticacaoFilter:doFilter()");
        }
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("autenticacaoFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("autenticacaoFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("autenticacaoFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("autenticacaoFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("autenticacaoFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
