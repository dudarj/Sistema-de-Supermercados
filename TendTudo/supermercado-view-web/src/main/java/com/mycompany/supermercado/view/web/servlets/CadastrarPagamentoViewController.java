...
public class CadastrarPagamentoViewController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            String descricaoPagamento = request.getParameter("descricaoPagamento");
            TipoPagamentoServico servico = new TipoPagamentoServico();
            TipoPagamento tipoPagamento = new TipoPagamento();
            if (descricaoPagamento != null && !descricaoPagamento.isEmpty()) {
                tipoPagamento.setDescricao(descricaoPagamento);
                servico.salvar(tipoPagamento);
                RequestDispatcher rd = request.getRequestDispatcher("TabelaPagamentoViewController");
