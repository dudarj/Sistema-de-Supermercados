 ...
 * @author Samuel
 */
@WebServlet(name = "DeletarPagamentoViewController", urlPatterns = {"/DeletarPagamentoViewController"})
public class DeletarPagamentoViewController extends HttpServlet {
