        ...
        <div class="modal__content">
          <div class="info">
            ...
            <p class="modal__description">
                Essa p�gina est� destinada para o cadastro de produtos, por favor preencha os campos!
            </p></div>
            <!-- FORMULARIO -->  
            <div class="container_1 form">
                ...
                <div id="form-wrap">
                  <div class="form-control">
                    <label for="username">C�digo do Produto</label>
                  ...
                  <div class="form-control">
                    <label for="email">Descri��o do Produto</label>
                    <input type="text" id="email" placeholder="Digite a descri��o do produto..." />
                    <i class="fas fa-exclamation-circle"></i>
                    <i class="fas fa-check-circle"></i>
                    <small>Mensagem de erro</small>
                  </div>
                  ...
                  <div class="form-control">
                    <label for="password">Pre�o do Produto</label>
                    <input
                      type="text"
                      id="password"
